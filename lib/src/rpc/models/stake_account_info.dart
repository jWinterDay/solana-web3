...
class StakeAccountInfo extends BorshObject {
  ...
  factory StakeAccountInfo.fromBorshBase64(final String encoded) => StakeAccountInfo.fromBorsh(base64.decode(encoded));
  ...
  factory StakeAccountInfo.fromAccountInfo(final AccountInfo info) {
    return info.isJson ? StakeAccountInfo.fromJson(info.jsonData) : StakeAccountInfo.fromBorshBase64(info.binaryData);
  }
