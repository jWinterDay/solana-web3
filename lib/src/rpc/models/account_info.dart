...
class AccountInfo<T> extends BorshObject with DataSerializableMixin {
  ...
  static AccountInfo fromBorshBase64(final String encoded) => AccountInfo.fromBorsh(base64.decode(encoded));
  ...
  static AccountInfo? tryFromJson(final Map<String, dynamic>? json) => json != null ? AccountInfo.fromJson(json) : null;
