...
mixin HttpConnection {
  ...
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<List<ClusterNode>>> getClusterNodesRaw() => send(GetClusterNodes());

  /// {@macro solana_web3.Connection.getClusterNodes}
  Future<List<ClusterNode>> getClusterNodes() async => (await getClusterNodesRaw()).result!;
  ...
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<EpochSchedule>> getEpochScheduleRaw() => send(GetEpochSchedule());

  /// {@macro solana_web3.Connection.getEpochSchedule}
  Future<EpochSchedule> getEpochSchedule() async => (await getEpochScheduleRaw()).result!;
  ...
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<u64>> getFirstAvailableBlockRaw() => send(GetFirstAvailableBlock());

  /// {@macro solana_web3.Connection.getFirstAvailableBlock}
  Future<u64> getFirstAvailableBlock() async => (await getFirstAvailableBlockRaw()).result!;

  /// {@template solana_web3.Connection.getGenesisHash}
  /// Returns the genesis hash.
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<String>> getGenesisHashRaw() => send(GetGenesisHash());
  ...
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<HealthStatus>> getHealthRaw() => send(GetHealth());
  ...
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<HighestSnapshotSlot>> getHighestSnapshotSlotRaw() => send(GetHighestSnapshotSlot());

  /// {@macro solana_web3.Connection.getHighestSnapshotSlot}
  Future<HighestSnapshotSlot> getHighestSnapshotSlot() async => (await getHighestSnapshotSlotRaw()).result!;

  /// {@template solana_web3.Connection.getIdentity}
  /// Returns the identity pubkey for the current node.
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<Identity>> getIdentityRaw() => send(GetIdentity());
  ...
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<InflationRate>> getInflationRateRaw() => send(GetInflationRate());

  /// {@macro solana_web3.Connection.getInflationRate}
  Future<InflationRate> getInflationRate() async => (await getInflationRateRaw()).result!;
  ...
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<u64>> getMaxRetransmitSlotRaw() => send(GetMaxRetransmitSlot());
  ...
  /// Returns the max slot seen from retransmit stage.
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<u64>> getMaxShredInsertSlotRaw() => send(GetMaxShredInsertSlot());
  ...
  Future<u64> getMinimumBalanceForRentExemption(
    ...
    final GetMinimumBalanceForRentExemptionConfig? config,
      ...
      (await getMinimumBalanceForRentExemptionRaw(length, config: config)).result!;
  ...
  Future<List<SignatureStatus?>> getSignatureStatuses(
    ...
    final GetSignatureStatusesConfig? config,
      ...
      (await getSignatureStatusesRaw(signatures, config: config)).result!.value!;
  ...
  Future<List<TokenAccount>> getTokenAccountsByDelegate(
    ...
    final GetTokenAccountsByDelegateConfig? config,
      ...
      (await getTokenAccountsByDelegateRaw(delegate, filter: filter, config: config)).result!.value!;
  ...
  Future<List<TokenAccount>> getTokenAccountsByOwner(
    ...
    final GetTokenAccountsByOwnerConfig? config,
      ...
      (await getTokenAccountsByOwnerRaw(account, filter: filter, config: config)).result!.value!;
  ...
  /// {@endtemplate}
  Future<JsonRpcSuccessResponse<u64>> minimumLedgerSlotRaw() => send(MinimumLedgerSlot());

  /// {@macro solana_web3.Connection.minimumLedgerSlot}
  Future<u64> minimumLedgerSlot() async => (await minimumLedgerSlotRaw()).result!;
  ...
  Future<TransactionSignature> sendSignedTransaction(
    ...
    final SendTransactionConfig? config,
      ...
      (await sendSignedTransactionRaw(signedTransaction, config: config)).result!;
  ...
  Future<List<JsonRpcResponse<TransactionSignature?>>> sendSignedTransactionsRaw(final List<String> signedTransactions,
  ...
  /// [Future.error] with the first error found in the response.
  Future<List<TransactionSignature?>> sendSignedTransactions(final List<String> signedTransactions,
      {final SendTransactionConfig? config, final bool? eagerError}) async {
    ...
    return responses
        .map<TransactionSignature?>(
            (final JsonRpcResponse response) => response is JsonRpcSuccessResponse ? response.result : null)
