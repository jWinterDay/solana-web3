...
abstract class JsonRpcListContextMethod<S, T> extends JsonRpcContextMethod<List, List<T>> {
  ...
  @override
  List<T> valueDecoder(final List value) => value.cast<S>().map(itemDecoder).toList(growable: false);
