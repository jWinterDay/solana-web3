...
MessageInstruction _$MessageInstructionFromJson(Map<String, dynamic> json) => MessageInstruction(
      programIdIndex: json['programIdIndex'] as int,
      accounts: (json['accounts'] as List<dynamic>).map((e) => e as int),
      data: json['data'] as String,
    );

Map<String, dynamic> _$MessageInstructionToJson(MessageInstruction instance) => <String, dynamic>{
