...
MessageHeader _$MessageHeaderFromJson(Map<String, dynamic> json) => MessageHeader(
...
Map<String, dynamic> _$MessageHeaderToJson(MessageHeader instance) => <String, dynamic>{
