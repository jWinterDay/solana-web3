...
class Authorized extends BorshObject {
  ...
  static Authorized? tryFromJson(final Map<String, dynamic>? json) => json != null ? Authorized.fromJson(json) : null;
...
class Lockup extends BorshObject {
  ...
  /// {@macro solana_common.Serializable.tryFromJson}
  static Lockup? tryFromJson(final Map<String, dynamic>? json) => json != null ? Lockup.fromJson(json) : null;
...
class LockupArgs extends BorshObject {
  ...
  /// {@macro solana_common.Serializable.tryFromJson}
  static LockupArgs? tryFromJson(final Map<String, dynamic>? json) => json != null ? LockupArgs.fromJson(json) : null;
...
class Stake extends BorshObject {
  ...
  factory Stake.fromBorshBase64(final String encoded) => Stake.fromBorsh(base64.decode(encoded));

  /// {@macro solana_borsh.BorshObject.tryFromBorshBase64}
  static Stake? tryFromBorshBase64(final String? encoded) => encoded != null ? Stake.fromBorshBase64(encoded) : null;
  ...
  /// {@macro solana_common.Serializable.tryFromJson}
  static Stake? tryFromJson(final Map<String, dynamic>? json) => json != null ? Stake.fromJson(json) : null;
...
class Delegation extends BorshObject {
  ...
  /// {@macro solana_borsh.BorshObject.tryFromBorsh}
  static Delegation? tryFromBorsh(final Iterable<int>? buffer) => buffer != null ? Delegation.fromBorsh(buffer) : null;

  /// {@macro solana_borsh.BorshObject.fromBorshBase64}
  factory Delegation.fromBorshBase64(final String encoded) => Delegation.fromBorsh(base64.decode(encoded));
  ...
  /// {@macro solana_common.Serializable.tryFromJson}
  static Delegation? tryFromJson(final Map<String, dynamic>? json) => json != null ? Delegation.fromJson(json) : null;
...
class StakeMeta extends BorshObject {
  ...
  /// {@macro solana_borsh.BorshObject.tryFromBorsh}
  static StakeMeta? tryFromBorsh(final Iterable<int>? buffer) => buffer != null ? StakeMeta.fromBorsh(buffer) : null;

  /// {@macro solana_borsh.BorshObject.fromBorshBase64}
  factory StakeMeta.fromBorshBase64(final String encoded) => StakeMeta.fromBorsh(base64.decode(encoded));
  ...
  /// {@macro solana_common.Serializable.tryFromJson}
  static StakeMeta? tryFromJson(final Map<String, dynamic>? json) => json != null ? StakeMeta.fromJson(json) : null;
