...
class MasterEditionAccount extends BorshObjectSized {
  ...
  factory MasterEditionAccount.fromJson(final Map<String, dynamic> json) => _$MasterEditionAccountFromJson(json);
...
class MetadataAccount extends BorshObject {
  ...
  /// {@macro solana_borsh.BorshObject.fromBorshBase64}
  static MetadataAccount fromBorshBase64(final String encoded) => MetadataAccount.fromBorsh(base64.decode(encoded));
  ...
  factory MetadataAccount.fromAccountInfo(final AccountInfo info) {
    return info.isJson ? MetadataAccount.fromJson(info.jsonData) : MetadataAccount.fromBorshBase64(info.binaryData);
  }
  ...
  /// {@macro solana_common.Serializable.fromJson}
  factory MetadataAccount.fromJson(final Map<String, dynamic> json) => _$MetadataAccountFromJson(json);
