...
class AddressLookupTableProgram extends Program {
  /// Address Lookup Table Program.
  AddressLookupTableProgram._() : super(Pubkey.fromBase58('AddressLookupTab1e1111111111111111111111111'));
  ...
  static TransactionInstruction extend({
    ...
    final List<Iterable<int>> data = [
      ...
      for (final Pubkey address in addresses) pubkeyCodec.encode(address.toBase58())
    ];
