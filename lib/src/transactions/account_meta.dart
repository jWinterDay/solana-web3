...
class AccountMeta extends Serializable {
  ...
  factory AccountMeta.signerAndWritable(final Pubkey pubkey) => AccountMeta(pubkey, isSigner: true, isWritable: true);

  /// {@macro solana_common.Serializable.fromJson}
  factory AccountMeta.fromJson(final Map<String, dynamic> json) => _$AccountMetaFromJson(json);
