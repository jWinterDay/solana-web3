...
class NonceAccount extends BorshObject {
  ...
  factory NonceAccount.fromJson(final Map<String, dynamic> json) => _$NonceAccountFromJson(json);
  ...
  static NonceAccount fromBorshBase64(final String encoded) => NonceAccount.fromBorsh(base64.decode(encoded));
  ...
  factory NonceAccount.fromAccountInfo(final AccountInfo info) {
    return info.isBinary ? NonceAccount.fromBorshBase64(info.binaryData) : NonceAccount.fromJson(info.jsonData);
  }
